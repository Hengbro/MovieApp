...
import com.example.movieapp.databinding.ItemNewFilmBinding
...
class HomeAdapter () : RecyclerView.Adapter<HomeAdapter.ViewHolder>(){
    ...
    inner class ViewHolder(private val itemBinding: ItemNewFilmBinding): RecyclerView.ViewHolder(itemBinding.root){
        fun bind(item : MovieModel, position: Int){
            itemBinding.apply {
                tvName.text = item.title
                tvTgl.text = item.release_date
                tvRating.text = item.vote_count.toString()
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        return ViewHolder(ItemNewFilmBinding.inflate(
